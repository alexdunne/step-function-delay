...
```bash
step-function-delay$ sam logs -n StockCheckerFunction --stack-name step-function-delay --tail
```
...
```bash
step-function-delay$ go test -v ./functions/...
```
...
```bash
aws cloudformation delete-stack --stack-name step-function-delay
```
